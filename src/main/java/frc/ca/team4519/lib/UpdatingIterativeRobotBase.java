...
public abstract class UpdatingIterativeRobotBase extends RobotBase {
    ...
    private UpdatingIterativeRobotBase.Mode m_lastMode = UpdatingIterativeRobotBase.Mode.kNone;
     ...
     */
    protected UpdatingIterativeRobotBase(double period) {
        m_period = period;
    ...
    private boolean m_updateFirstRun = true;

    public void allPeroidic() {
        if(m_updateFirstRun) {
            System.out.println("Default allPeriodic() method... Overload me!");
            m_updateFirstRun = false;
        }
    }
    ...
    protected void loopFunc() {
        ...
        if (isDisabled()) {
            ...
            // or from power-on.
            if (m_lastMode != UpdatingIterativeRobotBase.Mode.kDisabled) {
                LiveWindow.setEnabled(false);
                Shuffleboard.disableActuatorWidgets();
                disabledInit();
                m_watchdog.addEpoch("disabledInit()");
                m_lastMode = UpdatingIterativeRobotBase.Mode.kDisabled;
            }
            ...
            if (m_lastMode != UpdatingIterativeRobotBase.Mode.kAutonomous) {
                LiveWindow.setEnabled(false);
                Shuffleboard.disableActuatorWidgets();
                autonomousInit();
                m_watchdog.addEpoch("autonomousInit()");
                m_lastMode = UpdatingIterativeRobotBase.Mode.kAutonomous;
            }
            ...
            // from power-on.
            if (m_lastMode != UpdatingIterativeRobotBase.Mode.kTeleop) {
                LiveWindow.setEnabled(false);
                Shuffleboard.disableActuatorWidgets();
                teleopInit();
                m_watchdog.addEpoch("teleopInit()");
                m_lastMode = UpdatingIterativeRobotBase.Mode.kTeleop;
            }
            ...
            // power-on.
            if (m_lastMode != UpdatingIterativeRobotBase.Mode.kTest) {
                LiveWindow.setEnabled(true);
                Shuffleboard.enableActuatorWidgets();
                testInit();
                m_watchdog.addEpoch("testInit()");
                m_lastMode = UpdatingIterativeRobotBase.Mode.kTest;
            }
